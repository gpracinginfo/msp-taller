...
import { formatDate, getPriority } from './board-config';
        ...
        <div className="border-b p-4">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="text-sm font-semibold text-gray-500">
                Vehículos con cita futura que todavía no aparecen en el tablero.
              </p>
            </div>
          ...
          <div className="relative mt-4">
            ...
            <input
              ...
              placeholder="Buscar matrícula, cliente, teléfono, vehículo, mecánico, prioridad..."
              className="w-full rounded-2xl border bg-white py-3 pl-10 pr-3 text-sm font-semibold outline-none focus:border-indigo-600"
            />
          </div>
        </div>
        ...
        <div className="overflow-y-auto p-4">
          <div className="mb-3 flex items-center justify-between">
            ...
            <p className="text-xs font-semibold text-gray-400">
              Total citas futuras: {jobs.length}
            </p>
          </div>
          ...
          {filteredJobs.length === 0 ? (
            <div className="rounded-2xl border border-dashed border-indigo-200 bg-indigo-50 p-6 text-center">
              <p className="font-bold text-indigo-500">
                No hay citas futuras que coincidan con la búsqueda.
              </p>
            </div>
          ) : (
            <div className="grid gap-2 md:grid-cols-2 xl:grid-cols-3">
              {filteredJobs.map((job) => (
                <button
                  ...
                  className="rounded-2xl border border-indigo-100 bg-indigo-50 p-3 text-left transition hover:border-indigo-400 hover:bg-indigo-100"
                >
